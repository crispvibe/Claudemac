  ...
  <div class="prefs-font">
    <div class="mb-10">
      <div class="prefs-section-head">
        ...
        <span class="prefs-section-title">布局模式</span>
        <div class="prefs-section-divider"></div>
      </div>
    ...
    <div class="mb-10">
      <div class="prefs-section-head">
        <div class="prefs-section-divider"></div>
        <span class="prefs-section-title">界面配置</span>
        <div class="prefs-section-divider"></div>
      </div>
    ...
    <div class="mb-10">
      <div class="prefs-section-head">
        <div class="prefs-section-divider"></div>
        <span class="prefs-section-title">尺寸配置</span>
        <div class="prefs-section-divider"></div>
      </div>
          ...
          <div class="space-y-4">
            <div class="prefs-card">
              <div class="flex items-center justify-between">
                <div>
                  <h4 class="text-sm font-medium prefs-text-main">侧边栏展开宽度</h4>
            ...
            <div class="prefs-card">
              <div class="flex items-center justify-between">
                <div>
                  <h4 class="text-sm font-medium prefs-text-main">侧边栏收缩宽度</h4>
            ...
            <div class="prefs-card">
              <div class="flex items-center justify-between">
                <div>
                  <h4 class="text-sm font-medium prefs-text-main">菜单项高度</h4>
