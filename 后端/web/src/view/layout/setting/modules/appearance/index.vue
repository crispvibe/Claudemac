  ...
  <div class="prefs-font">
    ...
    <div class="mb-10">
      <div class="prefs-section-head">
        ...
        <span class="prefs-section-title">主题模式</span>
        <div class="prefs-section-divider"></div>
      </div>
    ...
    <div class="mb-10">
      <div class="prefs-section-head">
        <div class="prefs-section-divider"></div>
        <span class="prefs-section-title">主题颜色</span>
        <div class="prefs-section-divider"></div>
      </div>
    ...
    <div class="mb-10">
      <div class="prefs-section-head">
        <div class="prefs-section-divider"></div>
        <span class="prefs-section-title">全局尺寸</span>
        <div class="prefs-section-divider"></div>
      </div>
    ...
    <div class="mb-10">
      <div class="prefs-section-head">
        <div class="prefs-section-divider"></div>
        <span class="prefs-section-title">视觉辅助</span>
        <div class="prefs-section-divider"></div>
      </div>
