  ...
  <div class="prefs-font">
    <div class="prefs-card-bg p-4">
        ...
        <div class="grid grid-cols-3 gap-4">
          ...
          >
            ...
            <div class="min-w-0 flex-1">
              <span class="block text-sm font-semibold prefs-text-main">{{ colorItem.name }}</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="flex items-center justify-between p-4 bg-white dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-xl mb-6 shadow-sm">
        <div class="flex-1">
          <h4 class="text-base font-semibold prefs-text-main">自定义颜色</h4>
