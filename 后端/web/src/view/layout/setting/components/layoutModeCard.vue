<template>
  <div class="grid grid-cols-2 gap-6 prefs-font px-6">
    <div
      v-for="layout in layoutModes"
      :key="layout.value"
      class="prefs-layout-card"
      :class="{
    ...
    >
      ...
      <div class="text-center">
        <span class="block text-base font-semibold prefs-text-main mb-2" :class="{ 'text-current': modelValue === layout.value }" :style="modelValue === layout.value ? { color: primaryColor } : {}">{{ layout.label }}</span>
