...
<script setup>
  ...
  import { updateRolePolicies, fetchRolePolicyPaths } from '@/api/casbin'
  import { ref, watch } from 'vue'
  import { ElMessage } from 'element-plus'

  defineOptions({
    name: 'RoleApiScopePanel'
  })
  ...
  const init = async () => {
    ...
    const res = await fetchRolePolicyPaths({
  ...
  const authApiEnter = async () => {
    ...
    const res = await updateRolePolicies({
