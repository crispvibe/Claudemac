...
范围：只读排查 Mac 端 `Codevoke/Services/AccountRemote`、iOS 端 `CodevokeIOS/Codevoke/Networking` / 相关 ViewModel、后端 `后端/server`、官网远程连接说明。本文只沉淀证据和建议，不修改 Android UI 或业务代码。
...
- `Codevoke/Services/AccountRemote/RemoteAccountModels.swift:256-263`
- `Codevoke/ViewModels/DeviceProvisioningViewModel.swift:381-390`
...
- `Codevoke/ViewModels/DeviceProvisioningViewModel.swift:383-389`
- `Codevoke/Services/AccountRemote/RemoteAccountModels.swift:110-112`

Mac 的 `deviceUID` 来自 Keychain 内的 `DeviceIdentity`，首次不存在时生成 UUID；注册成功后保存后端返回的 `deviceID`。

证据：

- `Codevoke/Services/AccountRemote/DeviceIdentityStore.swift:67-80`
- `Codevoke/Services/AccountRemote/DeviceIdentityStore.swift:83-87`
- `Codevoke/ViewModels/DeviceProvisioningViewModel.swift:68-91`
...
- `CodevokeIOS/Codevoke/Models/RemoteAuthModels.swift:169-176`
- `CodevokeIOS/Codevoke/ViewModels/AuthViewModel.swift:440-456`
- `CodevokeIOS/Codevoke/Networking/RemoteAPIClient.swift:32-35`
...
- `CodevokeIOS/Codevoke/ViewModels/DeviceListViewModel.swift:39-45`
...
- `CodevokeIOS/Codevoke/Networking/RemoteDeviceClient.swift:37-50`
- `CodevokeIOS/Codevoke/Models/RemoteAuthModels.swift:290-294`
...
- `CodevokeIOS/Codevoke/Models/RemoteAuthModels.swift:340-379`
...
- `CodevokeIOS/Codevoke/ViewModels/DeviceConnectViewModel.swift:106-180`
- `CodevokeIOS/Codevoke/ViewModels/DeviceConnectViewModel.swift:286-299`
- `CodevokeIOS/Codevoke/Networking/SignalingClient.swift:119-141`
...
- `Codevoke/ViewModels/DeviceProvisioningViewModel.swift:60-99`
- `Codevoke/ViewModels/DeviceProvisioningViewModel.swift:296-343`

Mac 收到 `pending_connect` 后弹出/处理授权；收到 `relay` 后为对应连接创建 `RemoteWebRTCBridge` 并接入本机 RemoteChatServer。

证据：

- `Codevoke/ViewModels/DeviceProvisioningViewModel.swift:216-268`
...
- Mac 生成 UUID：`Codevoke/Services/AccountRemote/DeviceIdentityStore.swift:67-80`
- iOS 生成 UUID：`CodevokeIOS/Codevoke/Networking/DeviceIdentityStore.swift:50-64`
...
- iOS 列表过滤：`CodevokeIOS/Codevoke/ViewModels/DeviceListViewModel.swift:43-44`
...
- `rg --files Codevoke/Services/AccountRemote CodevokeIOS/Codevoke/Networking`
