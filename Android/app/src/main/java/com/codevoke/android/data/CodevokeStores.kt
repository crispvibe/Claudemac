...
class RemoteSessionStore(context: Context) {
    ...
    private companion object {
        const val PREFS_NAME = "codevoke.remote.session"
    }
}

class LocalDeviceIdentityStore(context: Context) {
    private val appContext = context.applicationContext
    private val prefs = SecurePrefs.open(appContext, "codevoke.remote.identity")
...
private object SecurePrefs {
    private const val TAG = "CodevokeStores"
