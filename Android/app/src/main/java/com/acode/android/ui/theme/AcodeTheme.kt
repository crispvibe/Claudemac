...
private val AcodeLightScheme = lightColorScheme(
    primary = AcodeColor.Ink,
    onPrimary = Color.White,
    background = Color.White,
    onBackground = AcodeColor.Ink,
    surface = Color.White,
    onSurface = AcodeColor.Ink,
    outline = AcodeColor.Hairline,
)

@Composable
fun AcodeTheme(content: @Composable () -> Unit) {
    MaterialTheme(
        colorScheme = AcodeLightScheme,
